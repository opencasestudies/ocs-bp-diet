...
Under<-Under + geom_point(data = diet_and_guidelines %>%
  ...
  theme(axis.text.x = element_text(angle = 70, 
        ...
        legend.position = "none")+
labs(title=" Global consumption of foods associated\n with health risk when underconsumed",
...
Over<-diet_and_guidelines %>%
 ...
 scale_y_continuous(breaks=c(0,100,500, 1000, 2000), labels =c(0,"100% \n optimal amount",500, 1000, 2000) )+
...
labs(title=" Global consumption of associated with\n health risk when overconsumed",
        x ="", y = "Percent consumption relative \n to guidelines")
...
labs(title=" Global consumption of foods associated\n with health risk when underconsumed",
        x ="", y = "Percent consumption relative \n to guidelines")+
  facet_wrap_paginate(~food, nrow = 4, scales = "fixed")
...
cowplot::plot_grid(Over, Over_age, Under, Under_age, labels = c("A", "B","C", "D"), ncol = 2,rel_widths = c(2, 1))
# library(patchwork)
