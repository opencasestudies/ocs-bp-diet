...
diet_data %>% filter(food == "milk") %>% group_by(sex) %>% descr(stats = "fivenum")
```
+----+-----------------+---------------------------------+----------------------+---------------------+---------+
...
N: 196  
                ...
                lower     mean   rei_id    upper   year_id
------------ -------- -------- -------- -------- ---------
         Min     2.71     3.02   115.00     3.35   2017.00
          Q1    20.75    22.33   115.00    24.07   2017.00
      Median    55.69    59.52   115.00    64.01   2017.00
          Q3   108.55   115.08   115.00   123.31   2017.00
         Max   299.87   316.62   115.00   333.67   2017.00
...
N: 196  
                ...
                lower     mean   rei_id    upper   year_id
------------ -------- -------- -------- -------- ---------
         Min     2.87     3.16   115.00     3.48   2017.00
          Q1    21.64    23.33   115.00    25.10   2017.00
      Median    58.08    62.30   115.00    67.53   2017.00
          Q3   111.47   119.81   115.00   127.37   2017.00       
...
N (normal) - The residuals are normally distributed. Note that the variables themesleves do not need to be normally distributed.

E (equal variances) - The variance of the residuals for the groups is similar. This is called [homoscedasticity ](https://www.statisticssolutions.com/homoscedasticity/){target="_blank"}. In otherwords the residuals are of similar size along the line.
