...
title <- ggdraw() + 
  draw_label(
    " Global trends in the consumption of foods",
    fontface = 'bold',
    hjust = 0.5
  ) +theme(
...
cowplot::plot_grid("title",Over, Over_age, Under, Under_age, ncol = 2, rel_widths = c(2.5, 1))
#cowplot::plot_grid(Over, Over_age, Under, Under_age, ncol = 2, rel_widths = c(2.35, 1), rel_heights = c(1.25, 1, 1.25,1))

# library(patchwork)
# Over+ Over_age + Under + Under_age + 
