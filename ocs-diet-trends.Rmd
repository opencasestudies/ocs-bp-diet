...
This following will allow us to select the first or third substring from each element of the `pdf_table` object.
...
So let's evaluate our assumptions for the groups we are comparing, starting with normality using Q-Q plots. We will assess fruit consumption again.
...
Let's add gender to this. We will aslo use the `viridis` package to change the colors.
