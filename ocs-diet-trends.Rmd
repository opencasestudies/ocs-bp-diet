...
bartlett.test(
  log10(pull(filter(all_age_diet_and_guidelines, food == "red meat"),
         mean_percent)) ~ 
    pull(filter(all_age_diet_and_guidelines, food == "red meat"),
         age_group_name))  
...
summary(aov(log10(pull(filter(all_age_diet_and_guidelines, food == "fruits"), 
               mean_percent)) ~ 
    pull(filter(all_age_diet_and_guidelines, food == "fruits"),
         age_group_name)))
...
```{r}
all_age_diet_and_guidelines %>% distinct(age_group_name)
...
summary(aov(log10(pull(filter(all_age_diet_and_guidelines, food == "red meat"), 
               mean_percent)) ~ 
    pull(filter(all_age_diet_and_guidelines, food == "red meat"),
         age_group_name)+ 
      Error(pull(filter(all_age_diet_and_guidelines, food == "red meat"),
         location_name))))
...
anova(lmer(
  ...
  pull(filter(all_age_diet_and_guidelines, food == "red meat"),
                  age_group_name)+
  (1| pull(filter(all_age_diet_and_guidelines, food == "red meat"),
            location_name))))
