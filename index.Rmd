...
OK! It looks like age really influences the consumption of these dietary factors. With the exception of trans fatty acids, the consumption of all of these dietary factors seems to decrease with age.  Let's also use the `viridis` package to change the colors.
...
# for instructors, fyi there may be something wrong with the data regarding trans fatty acids - as the data for malaysia in the age separated document appears to be different from that in the age collapsed data:
...
# we contacted GBS about this but did not hear back
```
