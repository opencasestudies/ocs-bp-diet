...
# lme4 requires Matrix >= 1.6-2: Matrix 1.6-1 has an older, incompatible
# CHOLMOD interface. Rebuild the packages that link to Matrix afterward.
install.packages(
...
```{r}
regextest <- readr::read_file(here("resources", "regEx.txt"))
regextest
```
