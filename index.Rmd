...
Here you can see a table of the sources for the health risks associated with the dietary factors. The first column is the risk factors and the second column is the health outcomes. The rest of the table shows evidence supporting these relationships. RCT stands for randomized control trials. A red dot means that the corresponding piece of evidence (column name) is absent, while a green dot means that it is present.
...
The authors of this article obtained the data from a variety of sources including household budget surveys and nutritional surveys regarding 24 hour recall of food consumption and 24 hour urinary sodium analysis. The data was derived from sales data from [Euromonitor](https://www.euromonitor.com/), data from the [United Nations Food and Agriculture Organization (FAO)](http://www.fao.org/home/en/), estimates about national availability of specific nutrients, from the Supply Utilization Accounts(SUA), and the [United States Department of Agriculture](https://www.usda.gov/)'s National Nutrition Database.
