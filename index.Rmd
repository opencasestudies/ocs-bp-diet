...
Hmmm these look a bit funny because the outliers in the box plots for the foods besides sugar-sweetened beverages are making the range much larger than the box plot themselves. We can calculate the values for the box plots our selves to deal with this:
