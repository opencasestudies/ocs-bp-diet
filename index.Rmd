...
We will start by considering **simple linear regression**, where we have one contunous predictor variable and one continuous outcome variable, as shown below:
