...
# Keep the compiled mixed-model packages aligned.  lme4 links against Matrix's
# CHOLMOD interface, so it must be rebuilt after installing this Matrix release.
install.packages(
